  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        >
          {/* React */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#61dafb] filter blur-[1.25px]">
            <FaReact className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* VS Code */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#007acc] filter blur-[1.25px]">
            <VscCode className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* Figma */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#F24E1E] filter blur-[1.25px]">
            <FaFigma className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* JavaScript */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#f7df1e] filter blur-[1.25px]">
            <FaJs className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* Java */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#e76f00] filter blur-[1.25px]">
            <FaJava className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* .NET */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#512bd4] filter blur-[1.25px]">
            <SiDotnet className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* GitHub */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-gray-400 dark:text-gray-200 filter blur-[1.25px]">
            <FaGithub className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* HTML5 */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#e34f26] filter blur-[1.25px]">
            <FaHtml5 className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* Laravel */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#FF2D20] filter blur-[1.25px]">
            <FaLaravel className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* Python */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#3776AB] filter blur-[1.25px]">
            <FaPython className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* Database */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#44B78B] filter blur-[1.25px]">
            <FaDatabase className="w-12 h-12 md:w-16 md:h-16" />
          </div>

          {/* SQL (MySQL logo) */}
          <div className="absolute left-0 top-0 opacity-25 dark:opacity-20 text-[#00758F] filter blur-[1.25px]">
