...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const spin = () => {
      ...
      // 2. Animate the 'Open to work' status badge along the circular arc (sweeps -3deg to +3deg slowly)
      const badgeAngle = Math.sin(ringAngle * 0.012) * 3;
              ...
              >
                <defs>
                  ...
                  <linearGradient id="ringGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#32f6b1ff" /> {/* Vibrant Neon Blue */}
                    <stop offset="40%" stopColor="#3b0aadff" /> {/* Hot Pink */}
                    <stop offset="50%" stopColor="#06073cff" /> {/* Electric Violet */}
                    <stop offset="60%" stopColor="#3b0aadff" /> {/* Hot Pink */}
                    <stop offset="100%" stopColor="#32f6b1ff" /> {/* High-Contrast Emerald Mint */}
                  </linearGradient>
                </defs>
                {/*
          ...
          >
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-gradient-to-r from-blue-500 via-indigo-500 to-cyan-500 border border-blue-400/20 dark:border-cyan-400/10 text-white px-6 py-3.5 rounded-xl font-semibold text-base shadow-md hover:shadow-indigo-500/20 hover:shadow-lg transition-all duration-350 text-center"
              >
                📄 Download CV
              </motion.a>
              <motion.a
